...
public class ReviewControllerTest {
  ...
  @Autowired
  private JacksonTester<ReviewDTO>      jsonReview;
  ...
  @Before
  public void setup() {
    List<ReviewDTO> reviewList = DummyDataUtil.generateDummyReview(1);
    ReviewDTO firstReview = reviewList.get(0);
    firstReview.setId(1);
  ...
  public void testCreateReview() throws Exception {
    Integer productId = 1;
    ReviewDTO review = DummyDataUtil.generateDummyReview(1).get(0);
    mvc.perform(
